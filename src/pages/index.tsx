...
import QuickPayModal from '@/components/quick_pay_widget/modal'
...
export default function Home() {
  ...
  return (
    <div className="bg-gray-50">
      ...
      <QuickPayModal open={modalOpen} setOpen={setModalOpen} amount={product.amountInUsdc} />
